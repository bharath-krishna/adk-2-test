...
coordinator_agent = Agent(
    ...
    model="gemini-flash-latest",
    instruction="""You are a coordinator agent that coordinates the workflow. You have a workflow as a sub agent.""",
    output_schema=str,
    sub_agents=[custom_workflow],
)

root_agent = Workflow(
    name="root_agent",
    edges=[
        ("START", coordinator_agent, completed_message_function),
    ],
)
